        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    //     '''
                    sh """
                            sshpass -p '${SERVER_PASSWORD}' scp -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/ace-windows-java/target/ROOT.war ACEPortal1@98.70.57.5::"\"C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/\""
                        """
