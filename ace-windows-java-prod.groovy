pipeline {
    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    //     '''
                    sh """
                            sshpass -p '${SERVER_PASSWORD}' scp -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/ace-windows-java-prod/target/ROOT.war ACEPortal1@98.70.57.5:'"C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/"'
                        """
     ...
     post {
        success {
            script {
                emailext body: '''<html><body><h2>Ace Windows WAR Deployed - Version # $BUILD_NUMBER - Deployment $BUILD_STATUS.</h2><br/>
                        <br/>
                    ...
                    subject: 'Ace Windows WAR Deployed Successfully - $PROJECT_NAME',
        ...
        failure {
            script {
                emailext body: '''<html><body><h2>Ace Windows WAR Failed - Build # $BUILD_NUMBER - Deployment $BUILD_STATUS.</h2><br/>
                        <br/>
                    ...
                    subject: 'Ace Windows WAR Deployment failed : $PROJECT_NAME',
