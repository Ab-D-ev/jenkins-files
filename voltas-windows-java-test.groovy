pipeline {
    ...
    stages {
        stage('Checkout') {
            steps {
                git branch: 'main', credentialsId: 'Omkar', url: 'git@github.com:OmkarMore-1999/VoltasPortal.git' 
            }
        }
        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    //     '''
                    sh """
                            sshpass -p '${SERVER_PASSWORD}' scp -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/voltas-windows-java-test/target/voltas-test.war ACEPortal1@98.70.57.5:'"C:/Program Files/Apache Software Foundation/Tomcat 9.0/webapps/"'
                        """
    ...
    post {
        success {
            script {
                emailext body: '''<html><body><h2>Voltas Java WAR Deployed - Version # $BUILD_NUMBER - Deployment $BUILD_STATUS.</h2><br/>
                        <br/>
                        <h2>Deployed on workflows3.actifyzone.com/voltas-test/API </h2>
                        <br/>
                    ...
                    subject: 'Voltas Java WAR Deployed Successfully - $PROJECT_NAME',
        ...
        failure {
            script {
                emailext body: '''<html><body><h2>Voltas Java WAR Failed - Build # $BUILD_NUMBER - Deployment $BUILD_STATUS.</h2><br/>
                        <br/>
                    ...
                    subject: 'Voltas Java WAR Deployment failed : $PROJECT_NAME',
