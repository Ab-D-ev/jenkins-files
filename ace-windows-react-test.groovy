pipeline {
    ...
    stages {
     ...
     post {
        success {
            script {
                emailext body: '''<html><body><h2>Ace Windows React Test Deployed - Version # $BUILD_NUMBER - Deployment $BUILD_STATUS.</h2><br/>
                        <br/>
                    ...
                    subject: 'Ace Windows React Test Deployed Successfully - $PROJECT_NAME',
        ...
        failure {
            script {
                emailext body: '''<html><body><h2>Ace Windows React Test Failed - Build # $BUILD_NUMBER - Deployment $BUILD_STATUS.</h2><br/>
                        <br/>
                    ...
                    subject: 'Ace Windows React Test Deployment failed : $PROJECT_NAME',
